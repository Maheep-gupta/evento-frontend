export default function Login() {
    return (
      <>
            <div class="h-screen bg-gradient-to-tl from-green-400 to-indigo-900 w-full pb-5 pt-16 px-4">
                <div class="flex flex-col items-center justify-center">
                <img
                        className="mx-auto h-20 w-auto"
                        src={require('../assets/evento.png')}
                        alt="Your Company"
                    />
                    ...
                    <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                        ...
                        <div class="w-full flex items-center justify-between py-5">
                            <hr class="w-full bg-gray-400"/>
                                ...
                                <div class="mt-8">
                                    <button  class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">Create my account</button>
                                </div>
                        </div>
                    </div>
                </div>
